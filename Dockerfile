...
CMD /coco-splunk-http-forwarder -url=$FORWARD_URL -env=$ENV -hostname=$HOSTNAME -workers=$WORKERS -buffer=$BUFFER -token=$TOKEN -batchsize=$BATCHSIZE -batchtimer=$BATCHTIMER
